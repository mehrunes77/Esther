...
class PlanetaryDataService {
    ...
    async fetchNASAFactSheets() {
        try {
            const response = await axios_1.default.get(`${this.nasaFactSheetBase}.html`, {
                timeout: 10000,
            });
    ...
    async fetchJPLSmallBodyData(bodyName) {
        try {
            const response = await axios_1.default.get(`${this.jplSbdbBase}.api`, {
                params: {
                    des: bodyName,
                    fields: 'full',
                },
    ...
    async fetchHorizonsData(bodyId) {
        try {
            const response = await axios_1.default.get(this.horizonsApi, {
                params: {
                    format: 'json',
                    COMMAND: bodyId,
                    EPHEM_TYPE: 'observer',
    ...
    getMockNASAData() {
        return {
            sun: {
                ...
                temperature: { min: 5778, avg: 5778, max: 15000000 },
     ...
     */
    async getPlanetsByCategory(category) {
        const mockData = this.getMockNASAData();
        const categoryMap = {
...
exports.default = PlanetaryDataService;
